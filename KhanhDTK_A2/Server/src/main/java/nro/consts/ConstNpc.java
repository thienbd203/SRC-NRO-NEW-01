...
public class ConstNpc {
        ...
        public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến"
                        ...
                        + "\b1 sao đen: +24% sức đánh gốc"
                        + "\b2 sao đen: +40% HP"
                        + "\b3 sao đen: +40% KI"
                        + "\b4 sao đen: +10% Chí mạng"
                        + "\b5 sao đen: +16% giáp"
                        + "\b6 sao đen: +16% né đòn"
                        + "\b7 sao đen: Mỗi giờ 2 thỏi vàng"
        ...
        public static final int MENU_TANG_CAPSULE = 55555;
        public static final int MENU_DUA_TOP = 504;
        public static final int MENU_MUA_MHBT = 506;
        public static final int BUFF_DO = 19062000;
        public static final int BAO_TRI = 19062001;
        ...
        public static final int MENU_MUA_DE = 1010;
        public static final int MENU_QUA_MOC_NAP = 1011;
        // end index 3 ông già
        ...
        public static final int MENU_SU_KIEN = 521;
        public static final int MENU_DOI_CANH = 522;
        public static final int MENU_TRUNG_THU = 523;
        public static final int MENU_SU_KIEN_HLW = 524;
        // thần mèo
